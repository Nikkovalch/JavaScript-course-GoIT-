...
// console.log(lessNumber(2, 5)); // 2
// console.log(lessNumber(3, -1)); // -1
// console.log(lessNumber(1, 1)); // 1
//======================================================================
...
//   //   if(Boolean(names[i]) === Boolean(phones[i])) {
//   //     console.log(`${names[i]} - ${phones[i]}`)
//   //   }
//   // }
//====Варіант 2
//   // for (const res of names) {
//   //   if (Boolean(res) === Boolean(phones[names.indexOf(res)])) {
//   //     console.log(`${res} - ${phones[names.indexOf(res)]}`);
//   //   }
//   // }
// }
...
//   "89001234567,89001112233,890055566377,34252342343242"
// );
//===============================================================================
...
// console.log(addCourse("Express", courses));
// console.log(addCourse("CSS", courses)); // 'Ви вже маєте такий курс'
// ===============================================================================
// const courses = ["HTML", "CSS", "JavaScript", "React", "PostgreSQL"];

// // function removeCourse(name, mass) {

// //   for(const mas of mass) {
// //     if(mas === name) {
// //       mass.splice(mass.indexOf(mas), 1)
// //       return mass
// //     }
// //   }
...
// // }
// // console.log(removeCourse('PostgreSQL', courses));

// // removeCourse('Vue'); // 'Курс із таким ім'ям не знайдено'
// function updateCourse(oldName, newName, mass) {
//     for(const mas of mass) {
//     if(mas === oldName) {
//       mass.splice(mass.indexOf(mas), 1, newName)
//       return mass
//     }
//   }
//   return "Курс із таким ім'ям не знайдено"
...
// console.log(updateCourse('Express', 'NestJS', courses));
// updateCourse(oldName, newName) - змінює ім'я на нове
